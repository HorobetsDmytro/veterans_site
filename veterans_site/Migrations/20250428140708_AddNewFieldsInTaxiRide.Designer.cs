...
namespace veterans_site.Migrations
{
    ...
    [Migration("20250428140708_AddNewFieldsInTaxiRide")]
    partial class AddNewFieldsInTaxiRide
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("veterans_site.Models.AccessibilityMarker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HasAccessibleToilet")
                        .HasColumnType("bit");

                    b.Property<bool>("HasBlindSupport")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("AccessibilityMarkers");
                });
            ...
            modelBuilder.Entity("veterans_site.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("VeteranCertificateNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("veterans_site.Models.GeneralChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("veterans_site.Models.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("veterans_site.Models.JobApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("veterans_site.Models.Resume", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("veterans_site.Models.SavedJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("veterans_site.Models.UserLastReadGeneralChat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserLastReadGeneralChats");
                });
            ...
            modelBuilder.Entity("veterans_site.Models.JobApplication", b =>
                {
                    ...
                    b.HasOne("veterans_site.Models.Job", "Job")
                        .WithMany("Applications")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("veterans_site.Models.Resume", "Resume")
                        .WithMany()
            ...
            modelBuilder.Entity("veterans_site.Models.TaxiRide", b =>
                {
                    ...
                    b.HasOne("veterans_site.Models.ApplicationUser", "Veteran")
                        .WithMany()
